...
const About = () => {
   ...
   <div className="md:h-screen mx-auto flex flex-col justify-center w-full md:w-9/12 pt-11 md:pt-0 pb-11 sm:pb-11 md:pb-0">
     ...
     <h4 className="mt-2 md:mt-4 text-dark text-lg sm:text-2xl md:text-4xl font-neue font-regular leading-normal sm:leading-normal md:leading-relaxed md:w-11/12">
      I'm Ijeoma Emeruwa, a Digital Product/UX Designer focused on designing 
      for growth and impact by simplifying complex ideas and creating end-to-end holistic
    ...
    <div className="my-11 mx-auto flex flex-col justify-center w-full md:w-9/12 md:pt-0 pb-11 sm:pb-11 md:pb-0">
     ...
     <h4 className="mt-2 md:mt-4 text-dark text-lg sm:text-2xl md:text-4xl font-neue font-regular leading-normal sm:leading-normal md:leading-relaxed md:w-11/12">
       My experience includes solving UX & business problems in several industries such as <span className="opacity-50">FinTech</span>, <span className="opacity-50">SaaS</span>, 
       <span className="opacity-50"> B2B</span>, <span className="opacity-50">Blockchain</span>, amongst others.
    ...
    <h4 className="mt-2 md:mt-4 text-dark text-lg sm:text-2xl md:text-4xl font-neue font-regular leading-normal sm:leading-normal md:leading-relaxed md:w-11/12">
       My process involves understanding users and business needs and working with a cross-functional team to take an
    ...
    <h4 className="mt-2 md:mt-4 text-dark text-lg sm:text-2xl md:text-4xl font-neue font-regular leading-normal sm:leading-normal md:leading-relaxed md:w-10/12">
       My goals revolve around continuous learning and progression. This is why I love working with companies and people who 
       take a design-first approach to solving meaningful problems and encourage a culture for effective collaboration and continuous development.
     </h4> 
    </div>  
</div> 
